 ...
 *
 */
package tiin57.lib.bcel;

import java.io.IOException;

import tiin57.lib.bcel.classfile.JavaClass;
import tiin57.lib.bcel.util.ClassPath;
 ...
 *
 * @see tiin57.lib.bcel.util.Repository
 * @see tiin57.lib.bcel.util.SyntheticRepository
 *
...
public abstract class Repository {
    ...
    private static tiin57.lib.bcel.util.Repository _repository = SyntheticRepository.getInstance();


    /** @return currently used repository instance
     */
    public static tiin57.lib.bcel.util.Repository getRepository() {
        return _repository;
    }
     ...
     */
    public static void setRepository( tiin57.lib.bcel.util.Repository rep ) {
        _repository = rep;
    }
