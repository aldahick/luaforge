...
public class IINC extends LocalVariableInstruction {
    ...
    public IINC(int n, int c) {
        ...
        this.opcode = tiin57.lib.bcel.Constants.IINC;
        this.length = (short) 3;
    ...
    public void dump( DataOutputStream out ) throws IOException {
        if (wide) {
            out.writeByte(tiin57.lib.bcel.Constants.WIDE);
        }
    ...
    private final void setWide() {
        wide = (n > tiin57.lib.bcel.Constants.MAX_BYTE) || (Math.abs(c) > Byte.MAX_VALUE);
        if (wide) {
