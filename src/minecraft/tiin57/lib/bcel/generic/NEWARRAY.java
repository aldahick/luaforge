...
public class NEWARRAY extends Instruction implements AllocationInstruction, ExceptionThrower,
    ...
    public NEWARRAY(byte type) {
        super(tiin57.lib.bcel.Constants.NEWARRAY, (short) 2);
        this.type = type;
    }
    ...
    public String toString( boolean verbose ) {
        return super.toString(verbose) + " " + tiin57.lib.bcel.Constants.TYPE_NAMES[type];
    }
    ...
    public Class[] getExceptions() {
        return new Class[] {
            tiin57.lib.bcel.ExceptionConstants.NEGATIVE_ARRAY_SIZE_EXCEPTION
        };
    }
