...
import tiin57.lib.bcel.verifier.statics.Pass1Verifier;
import tiin57.lib.bcel.verifier.statics.Pass2Verifier;
import tiin57.lib.bcel.verifier.statics.Pass3aVerifier;
import tiin57.lib.bcel.verifier.structurals.Pass3bVerifier;
 ...
 * @author Enver Haase
 * @see tiin57.lib.bcel.verifier.VerifierFactory
 * @see tiin57.lib.bcel.verifier.PassVerifier
 */
        ...
        while (p3as.hasNext()) {
            ...
            for (int i = 0; i < p3am.length; i++) {
                messages.add("Pass 3a, method " + meth + " ('"
                        + tiin57.lib.bcel.Repository.lookupClass(classname).getMethods()[meth]
                        + "'): " + p3am[i]);
            }
        }
        ...
        for (int k = 0; k < args.length; k++) {
            try {
                ...
                if (vr == VerificationResult.VR_OK) {
                    JavaClass jc = tiin57.lib.bcel.Repository.lookupClass(args[k]);
                ...
                // avoid swapping.
                v.flush();
                tiin57.lib.bcel.Repository.clearCache();
                System.gc();
